...
public static class CompositionRoot
{
    ...
    private static IServiceProvider CreateServiceProvider()
    {
        ...
        services.AddSingleton<ReportServiceClient>(); // регистрируем клиент для получения отчетов с сервера
    ...
    public static ReportServiceClient ReportServiceClient { get; } = Services.GetRequiredService<ReportServiceClient>();
}